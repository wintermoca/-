...
BEGIN_MESSAGE_MAP(CMy1Dlg, CDialogEx)
	...
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER1, &CMy1Dlg::OnNMCustomdrawSlider1)
	ON_WM_LBUTTONDOWN()
END_MESSAGE_MAP()
...
void CMy1Dlg::OnPaint()
{
	...
	CClientDC dc(this);
	dc.Ellipse( m_Pnt.x - m_Pos, m_Pnt.x - m_Pos, m_Pnt.x + m_Pos, m_Pnt.x + m_Pos);
}
...
void CMy1Dlg::OnNMCustomdrawSlider1(NMHDR* pNMHDR, LRESULT* pResult)
{
